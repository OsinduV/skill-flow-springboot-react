    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
      <div className="w-full max-w-6xl mx-auto grid md:grid-cols-2 shadow-md rounded-xl overflow-hidden bg-white dark:bg-gray-800">
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">Welcome Back!</h1>
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-6">
            Sign in to continue sharing and learning new skills on <strong>Skill Flow</strong>.
          </p>
